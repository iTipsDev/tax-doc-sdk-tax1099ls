...
import org.taxdataexchange.docs.tax1099ls.models.*;
import org.taxdataexchange.docs.tax1099ls.utils.*;
...
public class Tax1099LsDocumentGenerator {
    ...
    public static TaxDataList sampleData( ) {
        ...
        // Sample data
        // -----------------------------------------------------------------
        TaxData taxData = SampleData.sampleTaxData( "Tax1099Ls" );
    ...
    public static byte[] sampleQrAsPng( ) {
        ...
        String filePath = "samples/Tax1099Ls.qr.png";
    ...
    public static void samplePdf( ) {
        ...
        String filePath = "samples/Tax1099Ls.sample.pdf";
        FileUtils.bytesToFile( pdfBytes, filePath );
        System.out.println( filePath );

        String filePathPng = "samples/Tax1099Ls.sample.png";
    ...
    public static void addCoverPage() {
        ...
        String filePath2 = "samples/Tax1099Ls.cover.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
    ...
    public static void insertQrCode() {
        ...
        String filePath2 = "samples/Tax1099Ls.inserted.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
